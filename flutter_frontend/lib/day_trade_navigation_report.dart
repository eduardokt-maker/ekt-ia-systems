      ...
      build: (pw.Context context) => <pw.Widget>[
        ...
        if (rows.isEmpty)
          ...
          pw.TableHelper.fromTextArray(
            ...
            data: printOptimized
                ? rows.map((row) => row.take(12).toList()).toList()
                : rows,
            headerDecoration: const pw.BoxDecoration(color: PdfColors.grey800),
            headerStyle: pw.TextStyle(
              color: PdfColors.white,
              fontSize: printOptimized ? 8.1 : 6.6,
              fontWeight: pw.FontWeight.bold,
            ),
            headerAlignment: pw.Alignment.center,
            cellStyle: pw.TextStyle(fontSize: printOptimized ? 7.6 : 6.3),
            cellAlignment: pw.Alignment.center,
            cellPadding: pw.EdgeInsets.symmetric(
                horizontal: printOptimized ? 4 : 3,
                vertical: printOptimized ? 5 : 4.2),
            oddRowDecoration: const pw.BoxDecoration(color: PdfColors.grey100),
            border: pw.TableBorder.all(color: PdfColors.grey500, width: .45),
            columnWidths: printOptimized
                ? const <int, pw.TableColumnWidth>{
                    ...
                    8: pw.FixedColumnWidth(66),
                    9: pw.FixedColumnWidth(66),
                    10: pw.FixedColumnWidth(88),
                    11: pw.FixedColumnWidth(66),
                  }
